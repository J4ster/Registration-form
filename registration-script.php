...
elseif (!preg_match($uppercasePassword,$password) || 
...
$passErr="Password must be at least one uppercase letter, lowercase 
letter, digit, a special character with no spaces and minimum 8 length";
}
else{
$passErr=true;
}
...
if($fnameErr==1 && $lnameErr==1 && $emailErr==1 && 
$passErr==1 && $cpassErr==1)
{
